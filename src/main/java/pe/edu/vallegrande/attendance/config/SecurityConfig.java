        ...
        public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
                return http
                                ...
                                .authorizeExchange(auth -> auth
                                                ...
                                                .pathMatchers(HttpMethod.GET, "/asistencia/list/**")
                                                .hasAnyRole("USER", "ADMIN")

                                                // POST, PUT, DELETE: solo ADMIN
                                                .pathMatchers(HttpMethod.POST, "/asistencia/create/**")
                                                .hasRole("ADMIN")
                                                .pathMatchers(HttpMethod.PUT, "/asistencia/update/**")
                                                .hasRole("ADMIN")
                                                .pathMatchers(HttpMethod.PUT, "/asistencia/activate/**")
                                                .hasRole("ADMIN")
                                                .pathMatchers(HttpMethod.DELETE, "/asistencia/deactivate/**")
                                                .hasRole("ADMIN")
                                                .pathMatchers(HttpMethod.DELETE, "/asistencia/delete/**")
                                                .hasRole("ADMIN")
