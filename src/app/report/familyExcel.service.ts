                ...
                if (familyPersons.length === 0) {
                    ...
                    familyPersons.forEach((person, index) => {
                        dataToExport.push({
                            ...
                            'Tipo de Vivienda': family.typeOfHousing,
                            'Material de Vivienda': family.housingMaterial,
                            'Seguridad de Vivienda': family.housingSecurity,
                            'Ambiente del Hogar': family.homeEnvironment,
                            'N° de Habitaciones': family.numberRooms,
                            'N° de Dormitorios': family.numberOfBedrooms,
                            'Habitabilidad': family.habitability,
                            'Habitabilidad del Edificio': family.habitabilityBuilding,
