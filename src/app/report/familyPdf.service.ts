...
export class FamilyPdfService {
    ...
    generateDetailedFamilyReport(family: Family, familyMembers: Person[]): void {
        ...
        const housingData = [
            ...
            ['Tipo de Vivienda', family.typeOfHousing || 'No especificado'],
            ['Material de Vivienda', family.housingMaterial || 'No especificado'],
            ['Seguridad de Vivienda', family.housingSecurity || 'No especificado'],
            ['Ambiente del Hogar', family.homeEnvironment || 'No especificado'],
            ['Número de Habitaciones', family.numberRooms?.toString() || 'No especificado'],
            ['Número de Dormitorios', family.numberOfBedrooms?.toString() || 'No especificado'],
            ['Habitabilidad', family.habitability || 'No especificado'],
            ['Habitabilidad del Edificio', family.habitabilityBuilding || 'No especificado']
        ];
